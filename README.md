...
- In the case that normal distribution is expected, a **T Test** can be sued
  - **Welch's t-test**
  - **Student's t-test**
  - Because t-tests only work when the *distribution is normal* It is not usually advised a good means of hypothesis testing.
